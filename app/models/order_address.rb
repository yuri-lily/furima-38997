class OrderAddress
  ...
  def save
    ...
    Address.create(postal_cade: postal_cade, prefecture_id: prefecture_id, city: city, address: address,
                   address_sub: address_sub, phone_number: phone_number, order_id: order.id)
  end
end
